...
#pragma warning restore 0649
		...
		private Action<string> onLogItemCopyClick;

		public void Initialize( DebugLogRecycledListView listView ,Action<string> onLogItemCopyClick)
		{
			this.listView = listView;
			this.onLogItemCopyClick = onLogItemCopyClick;
...
// #endif
			...
			if (!string.IsNullOrEmpty(log))
			{
				if( onLogItemCopyClick != null)
					onLogItemCopyClick(log);
				else
					GUIUtility.systemCopyBuffer = log;
			}
		}
