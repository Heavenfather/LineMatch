...
namespace HotfixCore.Module
{
    ...
    public class TimerModule : ITimerModule, IModuleUpdate, IModuleDestroy
    {
        ...
        public void ResetTimer(int timerId, TimerHandler callback, float time, bool isLoop = false,
