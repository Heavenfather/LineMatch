...
using GameCore.Log;
using HotfixCore.DataStruck;

namespace HotfixCore.Module
{
    public sealed partial class ObjectPoolModule : IObjectPoolModule, IModuleAwake, IModuleUpdate, IModuleDestroy
    {
        private const int DEFAULT_CAPACITY = 200;
        private const float DEFAULT_EXPIRE_TIME = 60.0f;
        ...
        {
            return InternalCreateObjectPool(objectType, string.Empty, false, DEFAULT_EXPIRE_TIME, DEFAULT_CAPACITY,
                DEFAULT_EXPIRE_TIME, DEFAULT_PRIORITY);
        }
        ...
        {
            return InternalCreateObjectPool<T>(name, false, DEFAULT_EXPIRE_TIME, DEFAULT_CAPACITY, DEFAULT_EXPIRE_TIME,
                DEFAULT_PRIORITY);
        }
        ...
        {
            return InternalCreateObjectPool(objectType, name, false, DEFAULT_EXPIRE_TIME, DEFAULT_CAPACITY,
                DEFAULT_EXPIRE_TIME, DEFAULT_PRIORITY);
        }
        ...
        {
            return InternalCreateObjectPool<T>(string.Empty, false, DEFAULT_EXPIRE_TIME, capacity, DEFAULT_EXPIRE_TIME,
                DEFAULT_PRIORITY);
        }
        ...
        {
            return InternalCreateObjectPool(objectType, string.Empty, false, DEFAULT_EXPIRE_TIME, capacity,
                DEFAULT_EXPIRE_TIME, DEFAULT_PRIORITY);
        }
        ...
        {
            return InternalCreateObjectPool<T>(string.Empty, false, expireTime, DEFAULT_CAPACITY, expireTime,
                DEFAULT_PRIORITY);
        }
        ...
        {
            return InternalCreateObjectPool(objectType, string.Empty, false, expireTime, DEFAULT_CAPACITY, expireTime,
                DEFAULT_PRIORITY);
        }
        ...
        {
            return InternalCreateObjectPool<T>(name, false, DEFAULT_EXPIRE_TIME, capacity, DEFAULT_EXPIRE_TIME,
                DEFAULT_PRIORITY);
        }
        ...
        {
            return InternalCreateObjectPool(objectType, name, false, DEFAULT_EXPIRE_TIME, capacity, DEFAULT_EXPIRE_TIME,
                DEFAULT_PRIORITY);
        }
        ...
        {
            return InternalCreateObjectPool(objectType, name, false, expireTime, DEFAULT_CAPACITY, expireTime,
                DEFAULT_PRIORITY);
        }
        ...
        {
            return InternalCreateObjectPool(objectType, name, false, expireTime, capacity, expireTime,
                DEFAULT_PRIORITY);
        }
        ...
        {
            return InternalCreateObjectPool(objectType, string.Empty, true, DEFAULT_EXPIRE_TIME, DEFAULT_CAPACITY,
                DEFAULT_EXPIRE_TIME, DEFAULT_PRIORITY);
        }
        ...
        {
            return InternalCreateObjectPool<T>(name, true, DEFAULT_EXPIRE_TIME, DEFAULT_CAPACITY, DEFAULT_EXPIRE_TIME,
                DEFAULT_PRIORITY);
        }
        ...
        {
            return InternalCreateObjectPool(objectType, name, true, DEFAULT_EXPIRE_TIME, DEFAULT_CAPACITY,
                DEFAULT_EXPIRE_TIME, DEFAULT_PRIORITY);
        }
        ...
        {
            return InternalCreateObjectPool<T>(string.Empty, true, DEFAULT_EXPIRE_TIME, capacity, DEFAULT_EXPIRE_TIME,
                DEFAULT_PRIORITY);
        }
        ...
        {
            return InternalCreateObjectPool(objectType, string.Empty, true, DEFAULT_EXPIRE_TIME, capacity,
                DEFAULT_EXPIRE_TIME, DEFAULT_PRIORITY);
        }
        ...
        {
            return InternalCreateObjectPool<T>(string.Empty, true, expireTime, DEFAULT_CAPACITY, expireTime,
                DEFAULT_PRIORITY);
        }
        ...
        {
            return InternalCreateObjectPool(objectType, string.Empty, true, expireTime, DEFAULT_CAPACITY, expireTime,
                DEFAULT_PRIORITY);
        }
        ...
        {
            return InternalCreateObjectPool<T>(name, true, DEFAULT_EXPIRE_TIME, capacity, DEFAULT_EXPIRE_TIME,
                DEFAULT_PRIORITY);
        }
        ...
        {
            return InternalCreateObjectPool(objectType, name, true, DEFAULT_EXPIRE_TIME, capacity, DEFAULT_EXPIRE_TIME,
                DEFAULT_PRIORITY);
        }
        ...
        {
            return InternalCreateObjectPool(objectType, name, true, expireTime, DEFAULT_CAPACITY, expireTime,
                DEFAULT_PRIORITY);
        }
        ...
        public void Release()
        {
            Logger.Info("Object pool release...");
        ...
        {
            Logger.Info("Object pool release all unused...");
            GetAllObjectPools(true, _cachedAllObjectPools);
            foreach (ObjectPoolBase objectPool in _cachedAllObjectPools)
            {
            ...
            int priority) where T : ObjectBase
        {
            ...
            ObjectPool<T> objectPool = new ObjectPool<T>(name, allowMultiSpawn, autoReleaseInterval, capacity,
                expireTime, priority);
        ...
        private ObjectPoolBase InternalCreateObjectPool(Type objectType, string name, bool allowMultiSpawn,
            float autoReleaseInterval, int capacity,
            float expireTime, int priority)
        {
            if (objectType == null)
            {
            ...
            ObjectPoolBase objectPool =
                (ObjectPoolBase)Activator.CreateInstance(objectPoolType, name, allowMultiSpawn, autoReleaseInterval,
