    ...
    public static partial class MemoryPool
    {
        ...
        public static MemoryPoolInfo[] GetAllMemoryPoolInfos()
        {
            ...
            lock (_memoryCollections)
            {
                ...
                {
                    results[index++] = new MemoryPoolInfo(memoryCollection.Key,
                        memoryCollection.Value.UnusedMemoryCount, memoryCollection.Value.UsingMemoryCount,
                        memoryCollection.Value.AcquireMemoryCount, memoryCollection.Value.ReleaseMemoryCount,
                        memoryCollection.Value.AddMemoryCount, memoryCollection.Value.RemoveMemoryCount);
                }
            }
