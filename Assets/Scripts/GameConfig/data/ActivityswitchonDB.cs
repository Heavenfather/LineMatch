...
namespace GameConfig
{
    ...
    public partial class ActivityswitchonDB : ConfigBase
    {
        private Activityswitchon[] _data;
        private Dictionary<int, int> _idToIdx;
        
        protected override void ConstructConfig()
        {
            _data = new Activityswitchon[]
            {
        ...
        public ref readonly Activityswitchon this[int activity_id]
        {
            get
            {
                TackUsage();
                ...
                if (!ok)
                    UnityEngine.Debug.LogError($"[Activityswitchon] activity_id: {activity_id} not found");
                return ref _data[idx];
            }
        }
        
        public Activityswitchon[] All => _data;
