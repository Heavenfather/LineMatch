    ...
    public class JsonMapper
    {
        ...
        private static object ReadValue(Type inst_type, JsonReader reader)
        {
                ...
                reader.Token == JsonToken.Boolean)
            {
                ...
                {
                    if (custom_importers_table.TryGetValue(json_type,
                            out IDictionary<Type, ImporterFunc> customImporterTablesValue) &&
                ...
                if (base_importers_table.TryGetValue(json_type,
                        out IDictionary<Type, ImporterFunc> baseImporterTablesValue) &&
            ...
            else if (reader.Token == JsonToken.ObjectStart)
            {
                ...
                while (true)
                {
                    ...
                    else
                    {
                        ...
                        if (keyType != null)
                        {
                            ((IDictionary)instance).Add(Convert.ChangeType(property, keyType),
