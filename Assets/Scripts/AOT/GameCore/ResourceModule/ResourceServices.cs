...
namespace GameCore.Resource
{
    ...
    internal class RemoteServices : IRemoteServices
    {
        ...
        {
            return $"{GameSettings.Instance.ProjectSetting.GetCDNDownLoadPath()}/{fileName}";
        }

        string IRemoteServices.GetRemoteFallbackURL(string fileName)
        {
            return $"{GameSettings.Instance.ProjectSetting.GetFallbackCDNDownLoadPath()}/{fileName}";
        }
    }
